...
public partial class Level : Node2D
{
	...
	[ExportGroup("Formation Movement")]
	[Export] public float FormationSpeed = 80f; // px/sec
	...
	public override void _Ready()
	{
		...
		cam.GlobalPosition = vp.Size / 2f;  // critical if you place things at (0..width, 0..height)
		cam.Enabled = true;
	...
	private void SpawnFormation()
	{
		...
		// Clear old enemies if you re-run in editor
